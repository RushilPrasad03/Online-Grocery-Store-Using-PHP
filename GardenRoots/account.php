            ...
            <!-- DB DISPLAY !!!! -->
                ...
                ?>
                    <tr>
                        ...
                        <td>₹<?php echo $rows['total']?> for <?php echo mysqli_num_rows($orderCountResult);?> items</td>
