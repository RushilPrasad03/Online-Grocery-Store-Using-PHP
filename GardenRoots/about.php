...
// get gllery images
$galleryDisplay = "SELECT * FROM `admins` INNER JOIN `gallery` ON admins.admin_id=gallery.admin_id;";
...
<body>
    ...
    <div class="heading">
        <h1>about us</h1>
        <p class="heading-url"><a href="index.php">home </a>>> about </p>
    </div>
    <section class="about">
        <div class="image">
        ...
        <div class="box-container">
            ...
            <!-- DB DISPLAY !!!! -->
                ...
                <div class="box">
                    ...
                    <div class="content">
                        <div class="icons">
                            <a href="#" class="gallery-icon"> <i class="fas fa-calendar"></i> <?php echo $rows['date']; ?></a>
                            <a href="#" class="gallery-icon"> <i class="fas fa-user"></i> by <?php echo $rows['username']; ?></a>
                        </div>
                    </div>
                </div>
