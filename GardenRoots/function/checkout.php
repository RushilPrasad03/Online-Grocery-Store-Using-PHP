...
if($_SESSION['payment'] == "cash" || $_SESSION['payment'] == "credits" || $_SESSION['payment'] == "stripe-accept"){
    ...
    $stripe_secret_key = "sk_test_51NprWRSCmASzPtYLLgRSXbT2vWawhZAhJDnPHvVAC7w7wChAXspSj5HV7uCYDfiwId5LWwjTLZhZplDuqRSYXq8t00Rz4GNgVI";

    \Stripe\Stripe::setApiKey($stripe_secret_key);

    $checkout_session = \Stripe\Checkout\Session::create([
        "mode" => "payment",
        "success_url" => "http://localhost/GardenRoots/function/checkout.php",
        "cancel_url" => "http://localhost/GardenRoots/cart.php",
        "locale" => "auto",
        "line_items" => $itemsArray
    ]);

    $_SESSION['payment']= 'stripe-accept';
